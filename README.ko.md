...
개인 채팅에서만 사용할 수 있습니다. 한 번에 하나의 로그인만 진행할 수 있고 시도 후 10분의 대기 시간이 적용됩니다. 인증 안내와 복사하기 편한 코드 전용 메시지는 별도로 전송되며 둘 다 콘텐츠 보호가 활성화됩니다. 코드는 텔레그램 스포일러로 가려지고, 두 메시지는 성공·실패 또는 10분 제한 시간 경과 후 삭제됩니다.
